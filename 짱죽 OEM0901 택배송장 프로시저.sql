...
BEGIN
	...
	SELECT
		A."U_CARDNAME" AS "채널명L000Y",
		B."U_ORDERNO" AS "주문번호L000Y",
		B."U_RECEIVER" AS "아이디L000Y",
		B."U_RECEINM" AS "이름L000Y",
		B."U_RECTEL" AS "휴대폰L000Y",
		B."U_RECADD" AS "주소L000Y",
		B."U_RECPOST" AS "우편번호L000Y",
		B."U_ORDTYPE" AS "주문구분L000Y",
		'' AS "대분류L000Y",
		'' AS "중분류L000Y",
		B."U_ITEMNAME" AS "제품명L000Y",
		B."U_QUANTITY" AS "수량R000Y",
		B."U_REQUEST" AS "요청사항L000Y",
		B."U_ORDTYPE" || B."U_ITEMNAME" AS "출력사항L000Y",
		'' AS "우체국출력사항L000Y",
		C."TOTQTY" AS "총수량",
		CASE
			WHEN C."BOXQTY" = 1
			...
			ELSE 'BOX분리'
		END AS "BOX분리여부L000Y",
		C."BOXQTY" AS "BOX수량R000Y",
		C."TOTQTY" AS "이유식환산총수량R000Y",
		'' AS "기준품목L000Y",
		B."U_TRANTYPE" AS "배송형태L000Y",
		B."U_INVOICE" AS "결제딜번호L000Y",
		B."U_ORDTIME" AS "주문시간L000Y",
		B."U_ITEMCODE" AS "품목코드L000Y",
		B."U_TRANSDT" AS "배송일L000Y",
		B."U_PAYTYPE" AS "결제방법L000Y"
	FROM "@APR_SHOPM1" A
	INNER JOIN "@APR_SHOPM2" B ON A."DocEntry" = B."DocEntry"
	LEFT JOIN #TMPQTY C ON A."DocEntry" = C."DOCENTRY" AND B."U_ORDERNO" = C."HORDNO"
	...
	DROP TABLE #TMPQTY;
END;
CALL APR_OEM0901 ('20150528', '20150528', '20150529', '20150529', 'C00001');