...
BEGIN
	...
	WHERE A."Canceled" = 'N'
	AND ((TO_NVARCHAR(A."U_ORDERDT", 'YYYYMMDD') BETWEEN :FR_ORDT AND :TO_ORDT) OR ('' = :FR_ORDT AND '' = :TO_ORDT))
	AND (A."U_CARDCODE" = :CARDCODE OR '' = :CARDCODE)
	GROUP BY A."DocEntry", B."U_ORDERNO";
	
	SELECT
		-- COUNT(B."LineId") AS "순번R000Y",
	...
	DROP TABLE #TMPQTY;
END;
CALL APR_OEM0901('20190805', '20190805', 'C00001');