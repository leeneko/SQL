...
BEGIN
	...
	THEN
		...
		QUERY := :QUERY || 'D."ItemCode" AS "품명L004Y", ';
	...
	QUERY := :QUERY || 'FROM OINV A ';
	QUERY := :QUERY || 'INNER JOIN INV1 B ON A."DocEntry" = B."DocEntry" ';
